<%@ Page Title="" Language="C#" MasterPageFile="~/SilverInventory/Silver.Master" AutoEventWireup="true" CodeBehind="SilverDashBoard.aspx.cs" Inherits="Jazira.SilverInventory.SilverDashBoard" %>
    ...
    <div class="row">
        <div class="col-md-5 col-xs-5">
            <div class="page-heading">
                <h3>
                    <i class="fa fa-calendar-o"></i>&nbsp;Silver Inventory
                </h3>
            </div>
        </div> 
        <div class="col-md-7">
            <ul class="breadcrumb breadcrumb-modified pull-right" style="background-color:transparent;">
                ...
                <li class="active"><a href="SilverDashBoard.aspx">Silver Inventory</a></li>
            </ul>
        </div>
    </div>
    <div class="row">
