<%@ Page Title="" Language="C#" MasterPageFile="~/TimeManagement/Time.Master" AutoEventWireup="true" CodeBehind="TimeDashBoard.aspx.cs" Inherits="Jazira.TimeManagement.TimeDashBoard" %>
    ...
    <div class="row">
        <div class="col-md-5 col-xs-5">
            <div class="page-heading">
                <h3>
                    <i class="fa fa-calendar-o"></i>&nbsp;Time Management
                </h3>
            </div>
        </div> 
        <div class="col-md-7">
            <ul class="breadcrumb breadcrumb-modified pull-right" style="background-color:transparent;">
                ...
                <li class="active"><a href="TimeDashBoard.aspx">Time Management</a></li>
            </ul>
        </div>
    </div>
    <div class="row">
