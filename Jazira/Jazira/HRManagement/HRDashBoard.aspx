<%@ Page Title="" Language="C#" MasterPageFile="~/HRManagement/MR.Master" AutoEventWireup="true" CodeBehind="HRDashBoard.aspx.cs" Inherits="Jazira.HRManagement.HRDashBoard" %>
     ...
     <div class="row">
        <div class="col-md-5 col-xs-5">
            <div class="page-heading">
                <h3>
                    <i class="fa fa-calendar-o"></i>&nbsp;HR Management
                </h3>
            </div>
        </div>
        <div class="col-md-7">
            <ul class="breadcrumb breadcrumb-modified pull-right" style="background-color: transparent;">
                ...
                <li class="active"><a href="HRDashBoard.aspx">HR Management</a></li>
            </ul>
        </div>
    </div>
    <div class="row">
