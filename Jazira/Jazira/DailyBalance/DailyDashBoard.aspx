<%@ Page Title="" Language="C#" MasterPageFile="~/DailyBalance/Daily.Master" AutoEventWireup="true" CodeBehind="DailyDashBoard.aspx.cs" Inherits="Jazira.DailyBalance.DailyDashBoard" %>
    ...
    <div class="row">
        <div class="col-md-5 col-xs-5">
            <div class="page-heading">
                <h3>
                    <i class="fa fa-calendar-o"></i>&nbsp;Daily Balance
                </h3>
            </div>
        </div>
        <div class="col-md-7">
            <ul class="breadcrumb breadcrumb-modified pull-right" style="background-color: transparent;">
                ...
                <li class="active"><a href="DailyDashBoard.aspx">Daily Balance</a></li>
            </ul>
        </div>
    </div>
    <div class="row">
