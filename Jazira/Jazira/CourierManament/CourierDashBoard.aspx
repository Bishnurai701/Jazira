<%@ Page Title="" Language="C#" MasterPageFile="~/CourierManament/Courier.Master" AutoEventWireup="true" CodeBehind="CourierDashBoard.aspx.cs" Inherits="Jazira.CourierManament.CourierDashBoard" %>
    ...
    <div class="row">
        <div class="col-md-5 col-xs-5">
            <div class="page-heading">
                <h3>
                    <i class="fa fa-calendar-o"></i>&nbsp;Courier Management
                </h3>
            </div>
        </div>
        <div class="col-md-7">
            <ul class="breadcrumb breadcrumb-modified pull-right" style="background-color: transparent;">
                ...
                <li class="active"><a href="CourierDashBoard.aspx">CourierDashBoard</a></li>
            </ul>
        </div>
    </div>
    <div class="row">
