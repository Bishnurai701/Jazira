<%@ Page Title="" Language="C#" MasterPageFile="~/VehicleManagement/Vehicle.Master" AutoEventWireup="true" CodeBehind="VehicleDashBoard.aspx.cs" Inherits="Jazira.VehicleManagement.VehicleDashBoard" %>
    ...
    <div class="row">
        <div class="col-md-5 col-xs-5">
            <div class="page-heading">
                <h3>
                    <i class="fa fa-calendar-o"></i>&nbsp;Vehicle Management
                </h3>
            </div>
        </div>
        <div class="col-md-7">
            <ul class="breadcrumb breadcrumb-modified pull-right" style="background-color: transparent;">
                ...
                <li class="active"><a href="VehicleDashBoard.aspx">Vehicle Management</a></li>
            </ul>
        </div>
    </div>
    <div class="row">
