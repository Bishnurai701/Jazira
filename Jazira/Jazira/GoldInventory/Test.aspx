<%@ Page Title="" Language="C#" MasterPageFile="~/GoldInventory/Main.Master" AutoEventWireup="true" CodeBehind="Test.aspx.cs" Inherits="Jazira.GoldInventory.Test" %>
...
.general:hover
{
    ...
    <%-- <div class="row">
        <div class="col-md-6 col-xs-1">
            <h3>
              <i class="fa fa-male"></i>&nbsp;Dash Board
            </h3>
        </div>
    </div>
    <hr/>--%>
    <div class="row"> <%--<this is first row of dashboard>--%>
        <div class="col-xs-4 col-md-3">
            <a href="Member.aspx" class="gridiconbox"><%--thumbnail--or -- user defined scc class --gridiconbox--%>
                <div class="Inventory">
