<%@ Page Title="" Language="C#" MasterPageFile="~/GoldInventory/Main.Master" AutoEventWireup="true" CodeBehind="CastingDashBoard.aspx.cs" Inherits="Jazira.GoldInventory.CastingDashBoard" %>
...
.general:hover
{
    ...
    display:block;
        ...
        {
         height:460px;
         background-color:#eaeef2;/*#a4ceda*/
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="row">
        <div class="col-md-5 col-xs-5">
            <div class="page-heading">
                <h3>
                    <i class="fa fa-th fa-lg"></i>&nbsp;CASTING MENU
                </h3>
            </div>
        </div>
        <div class="col-md-7">
            <ul class="breadcrumb breadcrumb-modified pull-right" style="background-color: transparent;">
                ...
                <li class="active"><a href="CastingDashBoard.aspx">Casting Menu</a></li>
            </ul>
        </div>
    </div>
    <div class="row">
    ...
    <div class="row" id="Cast"><br /><br /> <%--<this is second row of dashboard>--%>
        <div class="col-xs-5 col-md-4">
            <a href="GoldInventory/GoldInventoryDashBoard.aspx" class="gridiconbox" data-toggle="tooltip" data-placement="bottom" title="Master Model Maintenance"><%--thumbnail--or -- user defined scc class --gridiconbox--%>
                <div class="Inventory">
                    <div class="col-md-12 btntext">Master model</div>
        ...
        <div class="col-xs-5 col-md-4">
            <a href="Member.aspx" class="gridiconbox" data-toggle="tooltip" data-placement="bottom" title="Order Section">
                <div class="Inventory">
                    <div class="col-md-12 btntext">Order Section</div>
        ...
        <div class="col-xs-5 col-md-4">
            <a href="Member.aspx" class="gridiconbox" data-toggle="tooltip" data-placement="bottom" title="Printing and Report">
                <div class="Inventory">
