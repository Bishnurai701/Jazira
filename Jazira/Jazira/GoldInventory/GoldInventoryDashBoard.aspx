<%@ Page Title="" Language="C#" MasterPageFile="~/GoldInventory/Main.Master" AutoEventWireup="true" CodeBehind="GoldInventoryDashBoard.aspx.cs" Inherits="Jazira.GoldInventory.GoldInventoryDashBoard" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="row">
            <div class="col-md-5 col-xs-5">
                ...
                <h3>
                    <i class="fa fa-calendar"></i>&nbsp; Gold Inventory Dash Board
                </h3>
                </div>
            </div>
            <div class="col-md-7">
                <ul class="breadcrumb breadcrumb-modified pull-right" style="background-color: transparent;">
                    ...
                    <li class="active"><a href="GoldInventoryDashBoard.aspx">Gold Inventory</a></li>
                </ul>
            </div>
        </div>
    <div class="row-fluid">
    ...
    <div class="row"> <%--<this is first row of dashboard>--%>
         <div class="col-xs-4 col-md-3">
            <a href="MenuDashBoard.aspx" class="gridiconboxSDB"  data-toggle="tooltip" data-placement="bottom" title="MAIN MENU"> 
                <div class="Inventory">
                    <div class ="col-md-12 btntext">MAIN MENU</div>
                    <img src="image/IconMainMenu.ico" class="img-responsive imgsize" />
                    <%--<div class="subtitle"></div>--%>
                </div>
            </a>
        </div>
        <div class="col-xs-3 col-md-3">
            <a href="../General/MasterMaintainance.aspx?act=GoldType" class="gridiconboxSDB" data-toggle="tooltip" data-placement="bottom" title="Master Maintenance"><%--thumbnail--or -- user defined scc class --gridiconboxSDB--%>
                <div class="Inventory">
                    <div class ="col-md-12 btntext">Mastere</div>
         ...
         <div class="col-xs-4 col-md-3">
            <a href="../General/GroupMasterMaintenace.aspx?act=search" class="gridiconboxSDB"  data-toggle="tooltip" data-placement="bottom" title="Group Master Maintenance">
                <div class="Inventory">
         ...
         <div class="col-xs-4 col-md-3">
            <a href="../General/ItemMaintenace.aspx?act=search" class="gridiconboxSDB" data-toggle="tooltip" data-placement="bottom" title="Item Maintenance">
                <div class="Inventory">
    ...
    <div class="row"> <%--<this is second row of dashboard>--%>
     ...
     <div class="row"> <%--<this is third row of dashboard>--%>
        <div class="col-xs-4 col-md-3">
         ...
         <div class="col-xs-4 col-md-3">
            <a href="GoldConfigurationDash.aspx" class="gridiconboxSDB" data-toggle="tooltip" data-placement="bottom" title="Gold Configuration">
                <div class="Inventory">
