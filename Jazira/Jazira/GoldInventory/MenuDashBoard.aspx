<%@ Page Title="" Language="C#" MasterPageFile="~/GoldInventory/Main.Master" AutoEventWireup="true" CodeBehind="MenuDashBoard.aspx.cs" Inherits="Jazira.GoldInventory.MenuDashBoard" %>
...
#Menu 
    {
    height:460px;
    background-color:#eeeeee;/*#a4ceda*/
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="row">
        <div class="col-md-4 col-xs-4">
            <div class="page-heading">
                <h3>
                    <i class="fa fa-th fa-lg"></i>&nbsp;MAIN MENU
                </h3>
            </div>
        </div>
        <div class="col-md-8">
            <ul class="breadcrumb breadcrumb-modified pull-right" style="background-color: transparent;">
                ...
                <li class="active"><a href="MenuDashBoard.aspx">Main Menu</a></li>
            </ul>
        </div>
    </div>
    ...
    <div class="row" id="Menu"> <br /><br /><%--<this is second row of dashboard>--%>
        <div class="col-xs-5 col-md-4">
            <a href="GoldInventory/GoldInventoryDashBoard.aspx" class="gridiconbox" data-toggle="tooltip" data-placement="bottom" title="SAFE BILL ENTRY"><%--thumbnail--or -- user defined scc class --gridiconbox--%>
                <div class="Inventory">
                    <div class="col-md-12 btntext">BILL ENTRY</div>
        ...
        <div class="col-xs-5 col-md-4">
            <a href="Member.aspx" class="gridiconbox" data-toggle="tooltip" data-placement="bottom" title="Next Month New Bill Entry">
                <div class="Inventory">
                    <div class="col-md-12 btntext">NXT MTH Bill Entry</div>
