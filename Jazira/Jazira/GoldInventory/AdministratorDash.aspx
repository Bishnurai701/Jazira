<%@Page Title="" Language="C#" MasterPageFile="~/GoldInventory/Main.Master" AutoEventWireup="true" CodeBehind="AdministratorDash.aspx.cs" Inherits="Jazira.GoldInventory.AdministratorDash" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
     <div class="row">
            ...
            <div class="col-md-8">
                <ul class="breadcrumb breadcrumb-modified pull-right" style="background-color: transparent;">
                    ...
                    <li class="active"><a href="AdministratorDash.aspx">GoldInventory</a></li>
                </ul>
            </div>
        </div>
    <div class="row-fluid">
    ...
    <div class="row"> <%--<this is first row of dashboard>--%>
        <div class="col-xs-3 col-md-3">
            <a href="../GoldInventory/UserType.aspx?act=search" class="gridiconboxSDB" data-toggle="tooltip" data-placement="bottom" title="Add User Type"><%--thumbnail--or -- user defined scc class --gridiconboxSDB--%>
                <div class="Inventory">
         ...
         <div class="col-xs-4 col-md-3">
            <a href="../GoldInventory/UserGroup.aspx?act=search" class="gridiconboxSDB" data-toggle="tooltip" data-placement="bottom" title="Add User Group">
                <div class="Inventory">
                    ...
                    <img src="../image/IconPassport.ico" class="img-responsive imgsize" />
         ...
         <div class="col-xs-4 col-md-3">
            <a href="Member.aspx" class="gridiconboxSDB">
                <div class="Inventory">
                    ...
                    <img src="../image/IconTNT.ico" class="img-responsive imgsize" />
