<%@ Page Title="" Language="C#" MasterPageFile="~/CashManagement/Cash.Master" AutoEventWireup="true" CodeBehind="CashDashBoard.aspx.cs" Inherits="Jazira.CashManagement.CashDashBoard" %>
    ...
    <div class="row">
        <div class="col-md-5 col-xs-5">
            <div class="page-heading">
                <h3>
                    <i class="fa fa-calendar-o"></i>&nbsp;Cash Management
                </h3>
            </div>
        </div>
        <div class="col-md-7">
            <ul class="breadcrumb breadcrumb-modified pull-right" style="background-color: transparent;">
                ...
                <li class="active"><a href="CashDashBoard.aspx">CashDashBoard</a></li>
            </ul>
        </div>
    </div>
    <div class="row">
