<%@ Page Title="" Language="C#" MasterPageFile="~/Security/Security.Master" AutoEventWireup="true" CodeBehind="FormMaster.aspx.cs" Inherits="Jazira.Security.FormMaster" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
     <div class="row">
        <div class="col-md-6 col-xs-6">
            <div class="page-heading">
                <h3>
                    <i class="fa fa-th-list fa-lg"></i>&nbsp;Form Master
                </h3>
            </div>
        </div>
        <div class="col-md-6">
            <ul class="breadcrumb breadcrumb-modified pull-right" style="background-color: transparent">
                ...
                <li><a href="../General/GeneralDashBoard.aspx">Configuartion</a><span class="divider"></span></li>
                <li><a href="SecurityDashBoard.aspx">Security</a><span class="divider"></span></li>
                <li class="active"><a href="FormMaster.aspx?act=search">Form Master</a></li>
            </ul>
        </div>
    </div>
    <div class="row">
    ...
    <div class="row">
        <div class="col-md-12 row-fluid-icon-modified" runat="server">
            ...
            <a href="FormMaster.aspx?act=search">
            ...
            <a href="FormMaster.aspx?act=add">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="form-group has-success">
                    ...
                    <div class="col-md-3">
                        <asp:TextBox ID="txtFromCode" runat="server" CssClass="form-control" placeholder="Form Code Here..."></asp:TextBox>
                    </div>
                </div>
                <div class="form-group has-success">
                    <label class="col-md-2 control-label">*Page Name</label>
                    <div class="col-md-6">
                        <asp:TextBox ID="txtPageName" runat="server" CssClass="form-control" placeholder="Page Name Here..."></asp:TextBox>
                    </div>
                </div>
                <div class="form-group has-success">
                    <label class="col-md-2 control-label">*Description</label>
                    <div class="col-md-6">
                        <asp:TextBox ID="txtDescription" runat="server" CssClass="form-control" placeholder="Description Here...."></asp:TextBox>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="row">
        <div class="col-md-12">
            <asp:GridView ID="dgvForm" runat="server" AutoGenerateColumns="false"
                    CssClass="table table-hover" Width="100%"
                    DataKeyNames="FormId" AllowPaging="true" PageSize="8" PagerStyle-CssClass="pagination-lg"
                    OnPageIndexChanging="dgvForm_PageIndexChanging">
                    <Columns>
                        <asp:BoundField DataField="FormCode" HeaderText="Code" />
                        <asp:BoundField DataField="PagenName" HeaderText="Page" />
                        <asp:BoundField DataField="DisplayName" HeaderText="Name" />
                        <asp:TemplateField HeaderText="Action" HeaderStyle-Width="170px"
                                ShowHeader="false" ItemStyle-CssClass="hide-data-when-print"
                                HeaderStyle-CssClass="hide-header-when-print">
                            <ItemTemplate>
                                <a href="<%#string.Format("FormMaster.aspx?act=edit&Id={0}",Eval("FormId"))%>";> <i class="fa fa-edit"></i> </a>&nbsp;
                                <a href="javascript:confirmAction('<%#string.Format("FormMaster.aspx?act=del&Id={0}",Eval("FormId")) %>','')"><i class="fa fa-trash-o"></i> </a>
