<%@ Page Title="" Language="C#" MasterPageFile="~/Security/Security.Master" AutoEventWireup="true" CodeBehind="SecurityDashBoard.aspx.cs" Inherits="Jazira.Security.SecurityDashBoard" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
     <div class="row">
            <div class="col-md-4 col-xs-4">
                <h4>
                    <i class="fa fa-user"></i>&nbsp; Security  Dash Board
                </h4>
            </div>
            <div class="col-md-8">
                <ul class="breadcrumb breadcrumb-modified pull-right" style="background-color: transparent;">
                    ...
                    <li class="active"><a href="SecurityDashBoard.aspx">Security </a></li>
                </ul>
            </div>
        </div>
    <div class="row-fluid">
     ...
     <div class="row"> <%--<this is first row of dashboard>--%>
        <div class="col-xs-3 col-md-3">
            <a href="User.aspx?act=search" class="gridiconboxSDB" data-toggle="tooltip" data-placement="bottom" title="Add User"><%--thumbnail--or -- user defined scc class --gridiconboxSDB--%>
                <div class="Inventory">
                    <div class ="col-md-12 btntext">User</div>
                    <img src="image/IconSecurity4.ico" class="img-responsive imgsize" />
                    <%--<div class="subtitle">Inventory Management</div>--%>
                </div>
            </a>
        </div>
         <div class="col-xs-4 col-md-3">
            <a href="../GoldInventory/UserGroup.aspx?act=search" class="gridiconboxSDB"  data-toggle="tooltip" data-placement="bottom" title="Add User Group">
                <div class="Inventory">
                    <div class ="col-md-12 btntext">User Group</div>
                    <img src="image/IconSecurity5.ico" class="img-responsive imgsize" />
                   
                </div>
            </a>
        </div>
         <div class="col-xs-4 col-md-3">
            <a href="../GoldInventory/UserType.aspx?act=search" class="gridiconboxSDB" data-toggle="tooltip" data-placement="bottom" title="Add User Type">
                <div class="Inventory">
                    <div class ="col-md-12 btntext">User Type</div>
                    <img src="image/IconUser.ico" class="img-responsive imgsize" />
                </div>
            </a>
        </div>
         <div class="col-xs-4 col-md-3">
            <a href="Member.aspx" class="gridiconboxSDB" data-toggle="tooltip" data-placement="bottom" title="Add User Right"> 
                <div class="Inventory">
                    <div class ="col-md-12 btntext">User Right</div>
                    <img src="image/IconSecurity6.ico" class="img-responsive imgsize" />
                </div>
            </a>
        </div>
   ...
   <hr class="inline" />
    ...
    <div class="row"> <%--<this is second row of dashboard>--%>
        <div class="col-xs-4 col-md-3">
            <a href="FormMaster.aspx?act=search" class="gridiconboxSDB" data-toggle="tooltip" data-placement="bottom" title="Form Master Details">
                <div class="Inventory">
                    <div class ="col-md-12 btntext">Form Mast</div>
                    <img src="image/IconSecurity7.ico" class="img-responsive imgsize" />
                    
                </div>
            </a>
        </div>
         <div class="col-xs-4 col-md-3">
            <a href="Member.aspx" class="gridiconboxSDB" data-toggle="tooltip" data-placement="bottom" title="Add User Type">
                <div class="Inventory">
