<%@ Page Title="" Language="C#" MasterPageFile="~/Account/Account.Master" AutoEventWireup="true" CodeBehind="AccountDashBoard.aspx.cs" Inherits="Jazira.Account.AccountDashBoard" %>
     ...
     <div class="row">
        <div class="col-md-5 col-xs-5">
            <div class="page-heading">
                <h3>
                    <i class="fa fa-calendar-o"></i>&nbsp;Account Dash Board
                </h3>
            </div>
        </div>
        <div class="col-md-7">
            <ul class="breadcrumb breadcrumb-modified pull-right" style="background-color: transparent;">
                ...
                <li class="active"><a href="AccountDashBoard.aspx">AccountDashBoard</a></li>
            </ul>
        </div>
    </div>
    <div class="row">
