<%@ Page Title="" Language="C#" MasterPageFile="~/ToolsManagement/Tools.Master" AutoEventWireup="true" CodeBehind="ToolsDashBoard.aspx.cs" Inherits="Jazira.ToolsManagement.ToolsDashBoard" %>
    ...
    <div class="row">
        <div class="col-md-5 col-xs-5">
            <div class="page-heading">
                <h3>
                    <i class="fa fa-calendar-o"></i>&nbsp;Tools Management
                </h3>
            </div>
        </div>
        <div class="col-md-7">
            <ul class="breadcrumb breadcrumb-modified pull-right" style="background-color: transparent;">
                ...
                <li class="active"><a href="ToolsDashBoard.aspx">Tools Management</a></li>
            </ul>
        </div>
    </div>
    <div class="row">
